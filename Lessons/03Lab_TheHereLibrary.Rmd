...
# SOMETIMES WHEN YOU'RE KNITTING, R CHANGES THE WORKING DIRECTORY SO YOU WON'T BE ABLE TO KNIT. EVERY TIME WE CREATE A FILE OR GET ONE SHARED, THE DEFAULT WILL BE DOCUMENT DIRECTORY, THE DIRECTORY WHERE YOUR DOC IS STORED. YOUR R PROJ FILE SHOULD ALWAYS ALWAYS BE THE PLACE YOUR WORKING DIRECTORY IS. Working directory should be set to the base folder for the Environmental Data Analytics Course repository, i.e., the folder that houses the R Project file.
...
```{r The here package}
#install.packages('here') WE NEED TO INSTALL THIS FIRST BEFORE WE CAN INSTALL THE PACKAGE 'HERE'
...
#Arguments in the `here()` command allow easy navigation within subfolders FROM THE PROJECT FOLDER YOU CAN NAVIGATE TO ANY FILE FOLDER YOU WANT . IF YOU USE THIS TO IMPORT YOUR DATA SET YOU'LL NEVER GET ERRORS WITH IMPORTING YOUR DATA FILE
...
# 1. 
#df <- read.csv("../Data/Raw/NTL-LTER_Lake_ChemistryPhysics_Raw.csv", stringAsFactors = TRUE)

df2 <- read.csv(here('Data', 'Raw', 'NTL-LTER_Lake_ChemistryPhysics_Raw.csv'),stringAsFactors = TRUE)
